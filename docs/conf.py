...
project = "sherpa_streamlit"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = sherpa_streamlit.__version__
release = sherpa_streamlit.__version__
...
apidoc_module_dir = os.path.dirname(sherpa_streamlit.__file__)
